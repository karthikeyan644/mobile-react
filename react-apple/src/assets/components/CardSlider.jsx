...
import SliderOne from "../images/slider-p-one.jpg";
import SliderTwo from "../images/slider-p-two.jpg";
import SliderThree from "../images/slider-p-three.jpg";

import SlideVone from "../videos/slider-v-two.mp4";
import SlideVtwo from "../videos/slider-v-one.mp4";
import SlideVthree from "../videos/slider-v-three.mp4";
